...
By combining the advantages from both random forest and gradient boosting, XGBoost gave the lowest prediction error in my case. (__Correction__) Actually it is similar to random forest. 
