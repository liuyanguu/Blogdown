...
(__Correction!__) 18.10.3. When I further test this dataset I realized it was a __mistake__. There is indeed no magic in machine learning. When I got a testing error ten-time smaller than other methods, I should question first if this is a mistake. I used the same dataset for training and testing. In the correct result XGBoost still gave the lowest testing rmse but was close to other two methods. 
