...
When I realized it was so convenient to write blog directly using R Markdown, I searched if there is a specific tool for it. And I found __Blogdown__, an R package developed by Yihui Xie, who is also the author of R Markdown. 
