...
When I realized it is so convenient to write blog directly using R Markdown, I searched if there is a specialized tool for it. And I found __Blogdown__, an R package written by Yihui Xie, who is also the author of R Markdown. 
