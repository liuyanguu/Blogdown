...
For a quick download: you can also download from my [github repo of `blogdown`]()
...
```{r}
# China -------------------------------------------------------------------
china_map <- rgdal::readOGR("D:/liuyanguu/Blogdown/blogData/China.shp/bou2_4p.shp") # read it locally
