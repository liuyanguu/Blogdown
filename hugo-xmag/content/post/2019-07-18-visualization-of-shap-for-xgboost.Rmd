---
title: 'SHAP visualization for XGBoost in R: SHAPforxgboost'
author: Yang Liu
date: '2019-07-18'
...
The R plotting functions used in this blog illustrates the R package **SHAPforxgboost".  
...
This function offers better visualization compared to its Python counterpart (in Python): `shap.summary_plot(shap_values, dataX)`. 

![](/post/2019-07-18-visualization-of-shap-for-xgboost_files/Python.summaryplot.PNG){width=50%}
...
g4 <- shap.plot.dependence.color(data_long = shap_long, x = 'dayint', y = 'Column_WV', color_feature = 'Column_WV') +  ggtitle("SHAP of CWV vs. Date")
...
int1 <- shap.plot.dependence.color(data_long = shap_long,
                           data_int = shap_int,
                           x= "Column_WV",
                           y = "AOT_Uncertainty", 
...
The corresponding interaction plot using Python code:
