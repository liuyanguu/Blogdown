...
Offers visualization improvement compared to its Python version:  
```{python, eval = F, echo = T}
...
* The correct interaction plot from Python:
...
![](/post/2019-07-18-visualization-of-shap-for-xgboost_files/int1.PNG)

![](/post/2019-07-18-visualization-of-shap-for-xgboost_files/int2.PNG)
