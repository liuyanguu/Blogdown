...
This summary function offers better visualization compared to its Python counterpart using `shap.summary_plot(shap_values, dataX)`, which looks like: 
...
g1 <- shap.plot.dependence.color(data_long = shap_long, x = 'dayint', y = 'dayint', color_feature = 'Column_WV') + ggtitle("SHAP of Date vs. Feature values of Date")
g2 <- shap.plot.dependence.color(data_long = shap_long, x = 'dayint', y = 'Column_WV', color_feature = 'Column_WV') +  ggtitle("SHAP of CWV vs. Date")
